 ...
 */
final class Version20210528100012 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande (num_cde INT AUTO_INCREMENT NOT NULL, code_clt_cde_id INT DEFAULT NULL, date_cde DATE NOT NULL, heure_cde TIME NOT NULL, remise_cde INT NOT NULL, mnt_cde DOUBLE PRECISION NOT NULL, INDEX IDX_6EEAA67DC10EE90D (code_clt_cde_id), PRIMARY KEY(num_cde)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ligne_cde (num_cde_ligne INT NOT NULL, code_jouet_ligne INT NOT NULL, num_cde INT DEFAULT NULL, qte_ligne INT NOT NULL, remise_ligne INT NOT NULL, INDEX IDX_5B71680B101C86AC (num_cde_ligne), INDEX IDX_5B71680BE64383DC (code_jouet_ligne), INDEX IDX_5B71680B991E96B1 (num_cde), PRIMARY KEY(num_cde_ligne, code_jouet_ligne)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
